...
export const DEFAULT_BOX_QUADRUPED_CALIBRATION: BoxQuadrupedCalibration = {
  ...
  elbowAngleSign: -1,
  shoulderAnchors: {
    front_left: [-2.55, -0.1, 2.55],
    front_right: [2.55, -0.1, 2.55],
    back_left: [-2.55, -0.1, -2.55],
    back_right: [2.55, -0.1, -2.55],
  },
  ...
  elbowOffsets: {
    front_left: [-0.7572, -4.8424, 0],
    front_right: [0.7572, -4.8424, 0],
    back_left: [-0.7572, -4.8424, 0],
    back_right: [0.7572, -4.8424, 0],
  },
  lowerLegCenterOffsets: {
    front_left: [-0.376, -2.53735, 0],
    front_right: [0.376, -2.53735, 0],
    back_left: [-0.376, -2.53735, 0],
    back_right: [0.376, -2.53735, 0],
  },
  upperLegRestAxisAngle: {
    front_left: { axis: [-0.616741, 0, 0.787166], angle: 0.264595 },
    front_right: { axis: [-0.616741, 0, -0.787166], angle: 0.264595 },
    back_left: { axis: [-0.592714, 0, 0.805413], angle: 0.261285 },
    back_right: { axis: [-0.592714, 0, -0.805413], angle: 0.261285 },
  },
