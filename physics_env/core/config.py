...
PROGRESS_REWARD_COEF = 2.50
PROGRESS_REWARD_STEP_SCALE = 0.03
FORWARD_SPEED_REWARD_COEF = 0.90
FORWARD_SPEED_SCALE = 0.75
SPARSE_CHECKPOINT_REWARD = 0.5
JOINT_LIMIT_PROGRESS_PENALTY_COEF = 0.15
ANGULAR_VELOCITY_PENALTY_COEF = 0.02
ACTION_SMOOTHNESS_PENALTY_COEF = 0.02
HEIGHT_PENALTY = 0.0
MIN_BODY_HEIGHT = 4.5
MAX_BODY_HEIGHT = 5.5
