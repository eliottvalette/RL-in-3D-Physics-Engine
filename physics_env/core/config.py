...
MOTOR_RESPONSE_GAIN = 0.04
MOTOR_IDLE_BRAKE_GAIN = 0.02
MOTOR_VELOCITY_DAMPING = 0.01
MOTOR_STOP_EPS = 1e-4
...
RESET_JOINT_ANGLE_JITTER = np.deg2rad(15.0)
...
TERMINAL_PENALTY_AIRBORNE = -2.0
PROGRESS_REWARD_COEF = 1.0
CONTACT_GRACE_STEPS = 5
MAX_AIRBORNE_STEPS = 25
